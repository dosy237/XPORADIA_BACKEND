...
urlpatterns = [
    ...
    path("school-groups/", views.CreateSchoolGroupView.as_view(), name="school-group-create"),
    path("school-groups/mine/", views.MySchoolGroupView.as_view(), name="school-group-mine"),
    path("school-groups/invite/", views.InviteToSchoolGroupView.as_view(), name="school-group-invite"),
    path(
        "school-groups/my-invitations/",
        views.MySchoolGroupInvitationsView.as_view(),
        name="school-group-my-invitations",
    ),
    path(
        "school-groups/invitations/<int:pk>/respond/",
        views.RespondSchoolGroupInvitationView.as_view(),
        name="school-group-invitation-respond",
    ),
